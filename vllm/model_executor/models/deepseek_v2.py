...
from vllm.model_executor.layers.expert_prefetch import ExpertCache, FatePredictor
...
class DeepseekV2DecoderLayer(nn.Module):
    def __init__(
        ...
        topk_indices_buffer: torch.Tensor | None = None,
        fate_predictor: Optional[FatePredictor] = None,
    ) -> None:
        super().__init__()
        ...
        self.fate_predictor = fate_predictor
...
class DeepseekV2Model(nn.Module):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = "", 
                 expert_cache: ExpertCache | None = None, fate_predictor: FatePredictor | None = None):
        super().__init__()
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: DeepseekV2DecoderLayer(
                vllm_config, prefix, topk_indices_buffer=topk_indices_buffer, fate_predictor=self.fate_predictor
            ),
...
class DeepseekV2ForCausalLM(
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.model = DeepseekV2Model(
            vllm_config=vllm_config, prefix=maybe_prefix(prefix, "model"), expert_cache=self.expert_cache, fate_predictor=self.fate_predictor
        )
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        if getattr(self.model, "fate_predictor", None) is not None:
            self.model.fate_predictor.load_gate_weights(self.model.layers)
