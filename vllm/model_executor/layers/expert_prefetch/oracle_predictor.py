...
class OraclePredictor: 
    ...
    def predict_experts(self, seq_id, step, layer_id, top_k=8):
        ...
        with h5py.File(self.data_path, "r") as f:
            #note: first step is the prefill step
            ...
            path = f"{seq_id}/step_{step}/layer_{layer_id}/router_logits"
            ...
            if path in f:
                ...
                return None  
    def predict_experts_batch(self, seq_ids: list, steps:list, layer_ids, top_k=8):
        predictions = []
        # steps = steps.tolist()
...
def main():
    predictor = OraclePredictor(data_path="/home/hieuvt/vllm-hpclab/dataset_generate/dataset_hidden_states_wrong.h5")
